...
class MyRecipesAdapter(val recipeList:ArrayList<Recipe>): RecyclerView.Adapter<MyRecipesAdapter.MyRecipeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyRecipeViewHolder, position: Int) {
        with(holder.view){
            ...
            imageView3.setOnClickListener {
                ...
                val action = MyRecipesFragmentDirections.actionRecipeDetail2(name.toString(), category.toString(), like!!, poster.toString(), id!!
                )
